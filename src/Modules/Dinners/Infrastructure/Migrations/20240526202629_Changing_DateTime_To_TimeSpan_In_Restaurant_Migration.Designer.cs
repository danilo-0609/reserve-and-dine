...
namespace Dinners.Infrastructure.Migrations
{
    ...
    [Migration("20240526202629_Changing_DateTime_To_TimeSpan_In_Restaurant_Migration")]
    partial class Changing_DateTime_To_TimeSpan_In_Restaurant_Migration
    {
        /// <inheritdoc />
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("ReservationInformation", "Dinners.Domain.Reservations.Reservation.ReservationInformation#ReservationInformation", b1 =>
                        {
                            ...
                            b1.ComplexProperty<Dictionary<string, object>>("ReservationPrice", "Dinners.Domain.Reservations.Reservation.ReservationInformation#ReservationInformation.ReservationPrice#Price", b2 =>
                                {
                                    b2.IsRequired();
                            ...
                            b1.OwnsOne("Dinners.Domain.Common.Price", "Price", b2 =>
                                {
                                    ...
                                    b2.Property<decimal>("Amount")
                                        .HasPrecision(10, 2)
                                        .HasColumnType("decimal")
                                        .HasColumnName("TablePrice");

                                    b2.Property<string>("Currency")
                                        .IsRequired()
                                        .HasColumnType("nvarchar(max)")
                                        .HasColumnName("TablePriceCurrency");

                                    b2.HasKey("RestaurantTableId");

                                    b2.ToTable("RestaurantTables", "dinners");
