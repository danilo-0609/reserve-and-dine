            ...
            modelBuilder.Entity("Domain.Restaurants.Restaurant", b =>
                {
                    ...
                    b.Property<DateTime?>("LastCheckedCurrentDaySchedule")
                        .HasColumnType("datetime2")
                        .HasColumnName("LastCheckedCurrentDaySchedule");

                    b.Property<DateTime?>("LastCheckedScheduleStatus")
                        .HasColumnType("datetime2")
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("CurrentDaySchedule", "Domain.Restaurants.Restaurant.CurrentDaySchedule#DayOfOperation", b1 =>
                        {
                            b1.IsRequired();

                            b1.Property<int>("DayOfWeek")
                                .HasColumnType("int")
                                .HasColumnName("CurrentDaySchedule");
                        });
